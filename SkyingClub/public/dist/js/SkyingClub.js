...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('SkyingClub:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('SkyingClub:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('You load SkyingClub\'s "demo.js", \nthis file is only created for testing purposes!')
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize SkyingClub</h5><hr class="mb-2"/>'
  )
